...
const NHL_TEAMS = [
  ...
  { abbr: 'CAR', name: 'Carolina Hurricanes', city: 'Carolina', state: 'NC', conference: 'Eastern', division: 'Metropolitan' },
  { abbr: 'CHI', name: 'Chicago Blackhawks', city: 'Chicago', state: 'IL', conference: 'Western', division: 'Central' },
  { abbr: 'COL', name: 'Colorado Avalanche', city: 'Colorado', state: 'CO', conference: 'Western', division: 'Central' },
  ...
  { abbr: 'FLA', name: 'Florida Panthers', city: 'Florida', state: 'FL', conference: 'Eastern', division: 'Atlantic' },
  { abbr: 'LAK', name: 'Los Angeles Kings', city: 'Los Angeles', state: 'CA', conference: 'Western', division: 'Pacific' },
  { abbr: 'MIN', name: 'Minnesota Wild', city: 'Minnesota', state: 'MN', conference: 'Western', division: 'Central' },
  ...
  { abbr: 'NJD', name: 'New Jersey Devils', city: 'New Jersey', state: 'NJ', conference: 'Eastern', division: 'Metropolitan' },
  { abbr: 'NYI', name: 'New York Islanders', city: 'New York', state: 'NY', conference: 'Eastern', division: 'Metropolitan' },
  ...
  { abbr: 'TBL', name: 'Tampa Bay Lightning', city: 'Tampa Bay', state: 'FL', conference: 'Eastern', division: 'Atlantic' },
