...
const NHL_TEAMS = [
  ...
  { abbr: 'CAR', teamId: 'carolina-hurricanes', name: 'Carolina Hurricanes', city: 'Raleigh', state: 'North Carolina', conference: 'Eastern', division: 'Metropolitan', founded: 1972, colors: { primary: '#CC0000', secondary: '#000000', accent: '#A2AAAD' }, stadium: { name: 'PNC Arena', capacity: 18680, location: 'Raleigh, North Carolina' } },
  ...
  { abbr: 'COL', teamId: 'colorado-avalanche', name: 'Colorado Avalanche', city: 'Denver', state: 'Colorado', conference: 'Western', division: 'Central', founded: 1995, colors: { primary: '#6F263D', secondary: '#236192', accent: '#A2AAAD' }, stadium: { name: 'Ball Arena', capacity: 18007, location: 'Denver, Colorado' } },
  ...
  { abbr: 'FLA', teamId: 'florida-panthers', name: 'Florida Panthers', city: 'Sunrise', state: 'Florida', conference: 'Eastern', division: 'Atlantic', founded: 1993, colors: { primary: '#041E42', secondary: '#C8102E', accent: '#B9975B' }, stadium: { name: 'Amerant Bank Arena', capacity: 19250, location: 'Sunrise, Florida' } },
  ...
  { abbr: 'MIN', teamId: 'minnesota-wild', name: 'Minnesota Wild', city: 'St. Paul', state: 'Minnesota', conference: 'Western', division: 'Central', founded: 2000, colors: { primary: '#154734', secondary: '#A6192E', accent: '#DDCBA4' }, stadium: { name: 'Xcel Energy Center', capacity: 17954, location: 'St. Paul, Minnesota' } },
  ...
  { abbr: 'NJD', teamId: 'new-jersey-devils', name: 'New Jersey Devils', city: 'Newark', state: 'New Jersey', conference: 'Eastern', division: 'Metropolitan', founded: 1974, colors: { primary: '#CE1126', secondary: '#000000', accent: '#FFFFFF' }, stadium: { name: 'Prudential Center', capacity: 16514, location: 'Newark, New Jersey' } },
  { abbr: 'NYI', teamId: 'new-york-islanders', name: 'New York Islanders', city: 'Elmont', state: 'New York', conference: 'Eastern', division: 'Metropolitan', founded: 1972, colors: { primary: '#00539B', secondary: '#F47D30', accent: '#FFFFFF' }, stadium: { name: 'UBS Arena', capacity: 17255, location: 'Elmont, New York' } },
  ...
  { abbr: 'TBL', teamId: 'tampa-bay-lightning', name: 'Tampa Bay Lightning', city: 'Tampa', state: 'Florida', conference: 'Eastern', division: 'Atlantic', founded: 1992, colors: { primary: '#002868', secondary: '#FFFFFF', accent: '#000000' }, stadium: { name: 'Amalie Arena', capacity: 19092, location: 'Tampa, Florida' } },
