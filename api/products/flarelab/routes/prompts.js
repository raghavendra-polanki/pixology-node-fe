...
/**
 * GET /api/flarelab/prompts/templates/:stageType/:promptId/versions
...
router.get('/templates/:stageType/:promptId/versions', async (req, res) => {
  try {
    ...
    console.log(`[FlareLab API] Getting versions for ${stageType}:${promptId}`);

    const versions = await PromptTemplateService.getVersionHistory(stageType, promptId, req.db);
    ...
    console.error('[FlareLab API] Error getting version history:', error);
    res.status(500).json({
...
/**
 * GET /api/flarelab/prompts/templates/:stageType/:promptId/versions/:version
...
router.get('/templates/:stageType/:promptId/versions/:version', async (req, res) => {
  try {
    ...
    console.error('[FlareLab API] Error getting version:', error);
    res.status(500).json({
...
/**
 * POST /api/flarelab/prompts/templates/:stageType/:promptId/versions
...
router.post('/templates/:stageType/:promptId/versions', async (req, res) => {
  try {
    ...
    console.log(`[FlareLab API] Creating new version for ${stageType}:${promptId}`);
    ...
    console.error('[FlareLab API] Error creating version:', error);
    res.status(500).json({
...
/**
 * POST /api/flarelab/prompts/templates/:stageType/:promptId/versions/:version/activate
...
router.post('/templates/:stageType/:promptId/versions/:version/activate', async (req, res) => {
  try {
    ...
    console.log(`[FlareLab API] Activating version ${version} for ${stageType}:${promptId}`);
    ...
    console.error('[FlareLab API] Error activating version:', error);
    res.status(500).json({
...
/**
 * DELETE /api/flarelab/prompts/templates/:stageType/:promptId/versions/:version
...
router.delete('/templates/:stageType/:promptId/versions/:version', async (req, res) => {
  try {
    ...
    console.log(`[FlareLab API] Deleting version ${version} for ${stageType}:${promptId}`);
    ...
    console.error('[FlareLab API] Error deleting version:', error);
    res.status(500).json({
