...
import { Plus, Folder, Clock, Zap, Trash2, LogOut, RefreshCw, MoreVertical } from 'lucide-react';
...
interface ProjectsDashboardProps {
  ...
  onSelectProject: (project: FlairLabProject) => void;
    ...
    <div className="min-h-screen bg-[#0a0a0a] px-6 md:px-8 lg:px-12 py-8">
      <div className="max-w-[1600px] mx-auto">
            ...
            <div className="flex items-center gap-3 mb-4">
              ...
              <div>
                <h1 className="text-2xl font-bold text-white">
                  Flair<span className="text-orange-500">Lab</span>
                </h1>
        ...
        <Button
          ...
          disabled={isLoading}
          className="mb-8 bg-orange-600 hover:bg-orange-700 text-white rounded-xl"
          size="lg"
        >
        ...
        {isLoading && projects.length === 0 ? (
          ...
          <div className="text-center py-16">
            ...
            <p className="text-gray-500 mb-6">
              Create your first FlairLab project to get started
            </p>
            <Button
              onClick={handleCreateNew}
