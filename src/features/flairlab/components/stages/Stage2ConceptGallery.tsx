...
import type { FlairLabProject, StyleCard, CreateProjectInput } from '../../types/project.types';
          ...
          return (
            ...
            >
              ...
              <div className={`aspect-video relative flex items-center justify-center overflow-hidden bg-slate-900`}>
                ...
                {selectedConcept?.id === concept.id && (
                  <div className="absolute top-4 right-4 w-8 h-8 bg-orange-600 rounded-full flex items-center justify-center shadow-lg z-10">
