...
import { MatchupSelector } from '../ui/MatchupSelector';
  ...
  useEffect(() => {
    const loadTeams = async () => {
      try {
        ...
        // Restore from project if exists (no default selection for new projects)
      ...
      <div className="mb-6">
        ...
        {isLoadingTeams ? (
          ...
          <MatchupSelector
            ...
            onHomeSelect={setHomeTeamId}
            onAwaySelect={setAwayTeamId}
          />
        )}
      </div>
